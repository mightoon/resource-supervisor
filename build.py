...
def create_portable_package():
    ...
    with open(f'{output_dir}/一键启动.bat', 'w', encoding='utf-8') as f:
        ...
        f.write('echo 启动后请访问 http://localhost:5001\n')
        f.write('echo 内网访问地址: http://%%计算机名%%:5001 或 http://本机IP:5001\n')
        f.write('echo.\n')
        f.write(':: 延迟2秒后打开浏览器，确保服务已启动\n')
        f.write('start /min cmd /c "timeout /t 2 /nobreak >nul && start http://localhost:5001"\n')
    ...
    with open(f'{output_dir}/使用说明.txt', 'w', encoding='utf-8') as f:
        ...
        f.write('【访问地址】\n')
        f.write('本机访问: http://localhost:5001\n')
        f.write('内网访问: http://<服务器IP>:5001\n')
        f.write('         http://<服务器主机名>:5001\n\n')
        f.write('【默认账号】\n')
        f.write('用户名: admin\n')
        f.write('密码: 123456\n\n')
        f.write('【修改端口】\n')
